...
require("database/db_connect.php");
	$sql="SELECT * FROM blog_video WHERE blog_id=".$id;
	if ($result=mysqli_query($con,$sql))
	{
      	//count number of rows in query result
		$rowcount=mysqli_num_rows($result);
		...
		foreach ($result as $sharingscript => $sharing) {
			...
			echo '<iframe width="450" height="315" src='.$sharing['video_content'].' title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
	...
	if ($result=mysqli_query($con,$sql))
	{
		...
		foreach ($result as $sliderposts => $slideritem) {
      	# code...fetch actual category from categories table
			...
			echo '<li>
			<div class="blog-item">
			<img src="blogadmin/images/'.$slideritem['photo'].'" alt="arogyam cms" class="img-fluid" style="width:450px;height:350px"/>
	...
	if ($result=mysqli_query($con,$sql))
	{
		...
		foreach ($result as $bloggrid => $griditem) {
      	# code...
			...
			<img src="blogadmin/images/'.$griditem['photo'].'" class="img-fluid" alt="arogyam cms" style="width:350px;height:250px">
			</a>
			</div>
			<h3>
	...
	if ($result=mysqli_query($con,$sql))
	{
		...
		foreach ($result as $olderposts => $op) {
      	# code...
			...
			<img src="blogadmin/images/'.$op['photo'].'" class="img-fluid" alt="arogyam cms">
			</a>
			</div>
	...
	if ($result=mysqli_query($con,$sql))
	{
		...
		foreach ($result as $thefour => $fourdata) {
      	# code...
			...
			<img src="blogadmin/images/'.$fourdata['photo'].'" alt="arogyam cms" data-desoslide-caption="<h3>Latest Post '.$fourdata['id'].'</h3>">
	...
	if ($result=mysqli_query($con,$sql))
	{
		...
		foreach ($result as $onelatest => $onedata) {
      	# code...
			...
			<img src="blogadmin/images/'.$onedata['photo'].'" class="img-fluid" alt="arogyam cms" style="width:900px;height:500px">
			</a>
			</div>
					...
					echo '<div class="blog-grids row mb-3">
								<div class="col-md-5 blog-grid-left">
									<a href="single.php?id='.$postdata['id'].'">
										<img src="blogadmin/images/'.$postdata['photo'].'" class="img-fluid" alt="arogyam cms">
									</a>
								</div>
								<div class="col-md-7 blog-grid-right">
      	...
      	# code...
			echo '<div class="col-md-6 card">
							<a href="single.php?id='.$cdata['id'].'">
								<img src="blogadmin/images/'.$cdata['photo'].'" class="card-img-top img-fluid" alt="arogyam cms" style="width:480px;height:300px">
							</a>
							<div class="card-body">
					...
					echo '<div class="blog-grids row mb-3">
							<div class="col-md-5 blog-grid-left">
								<a href="single.php?id='.$specificblog['id'].'">
									<img src="blogadmin/images/'.$specificblog['photo'].'" class="img-fluid" alt="arogyam cms">
								</a>
							</div>
							<div class="col-md-7 blog-grid-right">
