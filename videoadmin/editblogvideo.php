   ...
   if(!isset($_SESSION['userid']) || $_SESSION['role']!='Admin')
   {
    header('Refresh:0;URL=error.php');
        ...
        if(isset($_POST['update_articles']))
        {
            ...
            $qry_update="UPDATE blog_video SET id='$blog_id',video_title='$video_title',video_content='$video_content' WHERE id='$id'";
            $res=mysqli_query($connect,$qry_update) or die(mysqli_error($connect));
            header("Location:listblogvideo.php");
    }


            $video_id = isset($_GET['id'])?$_GET['id']:'';
            //echo "<pre>"; print_r($video_id); echo "</pre>"; die();
            $qryvideo="SELECT * FROM blog_video WHERE id=".$video_id; 
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Edit Blog Video</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="val-skill">Edit Blod Video  
                                                    ...
                                                    <div class="col-lg-8">
                                                       ...
                                                       <?php
                                                        ...
                                                        ?>
                                                        <option value="<?php echo $row['id']; ?>" <?php if( $row['id']==$rowmg['blog_id'] ) { echo($select); }?>><?= $row['title']; ?></option>
                                                        <?php } ?>
                                                       </select>
                                                    </div>
                                                </div>
